...
class SequenceParallelPluginV2(RuntimePlugin):
    ...
    def sp_group(self) -> dist.ProcessGroup:
        ...
        if group is None:
            raise ValueError("SequenceParallelPluginV2 requires a TP process group")
        return group
    ...
    def _register_sequence_hook(self, module: nn.Module, rule: OpShardRule) -> None:
        if rule.pre_comm == "all_gather":
            ...
            raise NotImplementedError(
                "SequenceParallelPluginV2 supports seq rules with "
