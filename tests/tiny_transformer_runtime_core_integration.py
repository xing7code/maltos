...
def _run_worker(rank: int, args: argparse.Namespace) -> None:
    ...
    baseline_params = _named_tensors(baseline_model, {}, None, normalize_name=_normalize_param_name)
    sharded_params = _named_tensors(core.model, shard_rules, tp_group, normalize_name=_normalize_param_name)
